...
public class AboutUsAdapter extends ArrayAdapter<RegistrationModel.ResultBean.AboutUsBean> {

    Context context;


    public AboutUsAdapter(@NonNull Context context, int resource, List<RegistrationModel.ResultBean.AboutUsBean> dataBeans) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        RegistrationModel.ResultBean.AboutUsBean rowItem = getItem(position);
