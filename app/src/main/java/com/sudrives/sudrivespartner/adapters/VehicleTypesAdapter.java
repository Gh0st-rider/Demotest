...
public class VehicleTypesAdapter extends ArrayAdapter<RegistrationModel.ResultBean.VehicleTypesBean> {

    Context context;


    public VehicleTypesAdapter(@NonNull Context context, int resource, List<RegistrationModel.ResultBean.VehicleTypesBean> dataBeans) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        txtTitle.setText(rowItem.getVehicle_name());
