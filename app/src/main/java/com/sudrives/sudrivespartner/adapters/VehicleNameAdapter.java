...
public class VehicleNameAdapter extends ArrayAdapter<VehicleNameModel.Result> {

    Context context;


    public VehicleNameAdapter(@NonNull Context context, int resource, List<VehicleNameModel.Result> dataBeans) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        VehicleNameModel.Result rowItem = getItem(position);
